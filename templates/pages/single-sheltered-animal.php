			...
			<div class="single-animal-infobox">
				...
				<div class="animal-details">
					<div class="animal-additional-info">
						...
						<span><?php _e( 'Name', 'virtual-adoptions' ) ?>:</span> <?php echo get_the_title(); ?>
					</div>
					<div class="animal-additional-info">
						<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
							<path
						...
						<span><?php _e( 'Age', 'virtual-adoptions' ) ?>:</span> <?php echo $age; ?>
					</div>
					<div class="animal-additional-info">
						<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
							<path
						...
						<span><?php _e( 'In the shelter', 'virtual-adoptions' ) ?>:</span> <?php echo $sheltered_for ?>
						<br>
					</div>
					<div class="animal-additional-info">
						<svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
						...
						<span><?php _e( 'Sex', 'virtual-adoptions' ) ?>:</span> <?php echo $sex ?><br>
					</div>
