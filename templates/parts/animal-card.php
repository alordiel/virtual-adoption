	...
	<div class="animal-card-body">
		...
		<div class="animal-card-text">
			<div class="animal-additional-info">
				...
				<?php _e( 'Age', 'ars-virtual-adopt' ) ?>: <?php echo $age; ?>
			</div>
			<div class="animal-additional-info">
				<svg viewBox="0 0 30 30" height="30px" width="30px"
					 xmlns="http://www.w3.org/2000/svg">
				...
				<?php echo __( 'In the shelter', 'ars-virtual-adopt' ) . ': '. $sheltered_for?>
			</div>
		</div>
		...
		<?php else: ?>
			<div class="orange-button-wrap">
				<div class="adopted-button"><?php _e('Adopted', 'ars-virtual-adopt') ?></div>
			</div>
		<?php endif; ?>
		<div class="blue-button-wrap">
			<a href="<?php echo $animal_link ?>" class="blue-button"><?php _e('Read my story', 'ars-virtual-adopt') ?></a>
		</div>
	</div>
</div>
