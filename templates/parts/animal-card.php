	...
	<div class="animal-card-body">
		...
		<div class="animal-card-text">
			<div class="animal-additional-info">
				...
				<?php _e( 'Age', 'virtual-adoptions' ) ?>: <?php echo $age; ?>
			</div>
			<div class="animal-additional-info">
				<svg viewBox="0 0 30 30" height="30px" width="30px"
					 xmlns="http://www.w3.org/2000/svg">
				...
				<?php echo __( 'In the shelter', 'virtual-adoptions' ) . ': '. $sheltered_for?>
			</div>
		</div>
		<?php if ( $adopted_animals === [] || ! in_array( $post_id, $adopted_animals, true ) ): ?>
			<div class="blue-button-wrap">
				<a href="<?php echo $sponsor_link . '?aid=' . va_encode_id( $post_id ) ?>"
				   class="blue-button"><?php _e('Sponsor me', 'virtual-adoptions') ?></a>
			</div>
		<?php else: ?>
			<div class="orange-button-wrap">
				<div class="adopted-button"><?php _e('Adopted', 'virtual-adoptions') ?></div>
			</div>
		<?php endif; ?>
		<div class="blue-button-wrap">
			<a href="<?php echo $animal_link ?>" class="blue-button"><?php _e('Read my story', 'virtual-adoptions') ?></a>
		</div>
	</div>
</div>
